...
printf("---------5.0s---------\n");
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%0sa", -5, min);
	printf("\n");
	two = ft_printf("%0sa", -5, min);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%0sa", -7, min);
	printf("\n");
	two = ft_printf("%0sa", -7, min);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
