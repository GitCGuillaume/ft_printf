...
void	basic_value(void)
{
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%*.sa", 10, NULL);
	printf("\n");
	two = ft_printf("%*.sa", 10, NULL);
	printf("\n");
	if (one == two)
		ft_putstr_fd("ok", 1);
	else
...
printf("---------1---------\n");
	...
	printf("---------1---------\n");
	one = printf("%0*sa", 0, "-43");
	printf("\n");
	two = ft_printf("%0*sa", 0, "-43");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------11---------\n");
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%*.*sb", 0, -6 ,"-123");
	printf("\n");
	two = ft_printf("%*.*sb", 0, -6, "-123");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
void	star_point_star(void)
{
	...
	int two;
	printf("---------1---------\n");
	one = printf("%-*.1s", -7, "LYDI");
	printf("\n");
	two = ft_printf("%-*.1s", -7, "LYDI");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("---------1---------\n");
	one = printf("%-*.3s", -7, "LYDI");
	printf("\n");
	two = ft_printf("%-*.3s", -7, "LYDI");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%-*.4s", -7, "LYDI");
	printf("\n");
	two = ft_printf("%-*.4s", -7, "LYDI");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%-*.0s", -7, "LYDI");
	printf("\n");
	two = ft_printf("%-*.0s", -7, "LYDI");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%-*.5s", -7, "LYDI");
	printf("\n");
	two = ft_printf("%-*.5s", -7, "LYDI");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
