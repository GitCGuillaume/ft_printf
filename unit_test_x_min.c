...
void	basic_value(void)
{
	...
	two = 0;
		printf("---------12---------\n");
	one = printf("%0-*.*xa", 20, 0, 123);
	printf("\n");
	two = ft_printf("%0-*.*xa", 20, 0, 123);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
		printf("---------12---------\n");
	one = printf("%0*.*xa", 20, 30, 123);
	printf("\n");
	two = ft_printf("%0*.*xa", 20, 30, 123);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------12---------\n");
	one = printf("%0*.xa", 20, 123);
	printf("\n");
	two = ft_printf("%0*.xa", 20, 123);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	if (one == two)
		...
		ft_putstr_fd("KO", 1);
	printf("---------12---------\n");
	one = printf("%020xa", 123);
	printf("\n");
	two = ft_printf("%020xa", 123);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
		printf("---------12---------\n");
	one = printf("%0-20xa", 123);
	printf("\n");
	two = ft_printf("%0-20xa", 123);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
