...
printf("---------1---------\n");
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%-5ua", INT_MIN);
	printf("\n");
	two = ft_printf("%-5ua", INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------5.0d---------\n");
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%0*ua", -5, INT_MIN);
	printf("\n");
	two = ft_printf("%0*ua", -5, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%0*ua", -7, INT_MIN);
	printf("\n");
	two = ft_printf("%0*ua", -7, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");	
	printf("---------1---------\n");
	one = printf("%0*ua", -2, INT_MIN);
	printf("\n");
	two = ft_printf("%0*ua", -2, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%10.*ub", 6 ,INT_MIN);
	printf("\n");
	two = ft_printf("%10.*ub", 6, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------0.d---------\n");
	...
	printf("---------5.dINT_MIN---------\n");
	one = printf("%5.u", INT_MIN);
	printf("one=%d\n", one);
	printf("\n");
	two = ft_printf("%5.u", INT_MIN);
	printf("two=%d\n", two);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	...
	printf("\n");
printf("---------20.dINT_MIN---------\n");
	one = printf("%20.u", INT_MIN);
	printf("one=%d\n", one);
	printf("\n");
	two = ft_printf("%20.u", INT_MIN);
	printf("two=%d\n", two);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
...
printf("---------1-5---------\n");
	...
	printf("\n");
printf("---------1.*d---------\n");
	one = printf("%.*ua", -1, INT_MIN);
	printf("\n");
	two = ft_printf("%.*ua", -1, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%*.*ua", -5, 0, -43);
	printf("\n");
	two = ft_printf("%*.*ua", -5, 0, -43);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------1????---------\n");
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%*.*ub", 20, 6, INT_MIN);
	printf("\n");
	two = ft_printf("%*.*ub", 20, 6, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------1-123---------\n");
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%*.*ub", 29, 20, INT_MIN);
	printf("\n");
	two = ft_printf("%*.*ub", 29, 20, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------1-123---------\n");
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%*.*ub", 10, 6 , INT_MIN);
	printf("\n");
	two = ft_printf("%*.*ub", 10, 6, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%20.*ub", 6, INT_MIN);
	printf("\n");
	two = ft_printf("%20.*ub", 6, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1-123---------\n");
	one = printf("%6.*ub", 20, INT_MIN);
	printf("\n");
	two = ft_printf("%6.*ub", 20, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1-123---------\n");
	one = printf("%29.*ub", 20, INT_MIN);
	printf("\n");
	two = ft_printf("%29.*ub", 20, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------1-123---------\n");
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%-0.*ub", 0 , INT_MIN);
	printf("\n");
	two = ft_printf("%-0.*ub", 0, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1-123---------\n");
	one = printf("%-*.*ub", 0, 0 , INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*ub", 0, 0, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------2---------\n");
	...
	printf("\n");
	printf("---------1---------\n");
	one = printf("%-*.*ua", -25, 20, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*ua", -25, 20, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%-*.*ua", -5, -1, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*ua", -5, -1, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%-*.*ua", -5, 5, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*ua", -5, 5, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------1---------\n");
	one = printf("%-*.*ua", -15, -15, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*ua", -15, -15, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("---------7---------\n");
	   one = printf("%-*.*u", 0, 0, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*u", 0, 0, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------2---------\n");
	...
	printf("\n");
	printf("---------2---------\n");
	one = printf("%0*.*u", NULL, NULL, 1);
	printf("\n");
	two = ft_printf("%0*.*u", NULL, NULL, 1);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------2---------\n");
	one = printf("%0*.*u", 1, NULL, 1);
	printf("\n");
	two = ft_printf("%0*.*u", 1, NULL, 1);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------2---------\n");
	one = printf("%0*.*u", NULL, 1, 1);
	printf("\n");
	two = ft_printf("%0*.*u", NULL, 1, 1);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------1-5---------\n");
	one = printf("%0*.ua", 0, INT_MIN);
	printf("\n");
	two = ft_printf("%0*.ua", 0, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
void	minus_star_point_star_min(void)
{
	...
	printf("\n");
	printf("---------W_SPEC MAX---------\n");
	one = printf("%-*.*u", 0, 2147483647, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*u", 0, 2147483647, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
printf("---------W_SPEC MAX---------\n");
	one = printf("%-*.*u", 20, 4, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*u", 20, 4, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------?????????---------\n");
	one = printf("%-*.*u", 4, 20, INT_MIN);
	printf("\n");
	two = ft_printf("%-*.*u", 4, 20, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
void	width_min_max_special(void)
{
	...
	one = printf("%.2147483647u", INT_MIN);
	printf("one==%d\n", one);
	printf("\n");
	two = ft_printf("%.2147483647u", INT_MIN);
	printf("two==%d\n", two);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
