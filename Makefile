...
SRCS	=	./ft_printf.c $(MANAGE)/ft_manage_convertor.c $(MANAGE)/ft_manage_specification.c $(MANAGE)/ft_manage_indicator.c $(MANAGE)/ft_manage_width.c $(PRINTS)/print_d.c $(PRINTS)/print_d_tools.c $(PRINTS)/print_d_specification.c $(PRINTS)/print_d_special.c $(PRINTS)/print_s.c $(PRINTS)/print_s_specification.c $(PRINTS)/print_s_tools.c $(PRINTS)/print_s_tools_two.c $(PRINTS)/print_p.c $(PRINTS)/print_tool.c $(PRINTS)/print_p_tool.c $(PRINTS)/print_p_tool_two.c $(PRINTS)/print.c  $(PRINTS)/ft_putnbr_base.c $(PRINTS)/print_c.c $(PRINTS)/print_c_tool.c $(PRINTS)/print_u.c $(PRINTS)/print_u_tool.c $(PRINTS)/print_u_tool_two.c $(PRINTS)/print_x.c $(PRINTS)/print_x_tool.c $(PRINTS)/ft_putnbr_base_x.c
