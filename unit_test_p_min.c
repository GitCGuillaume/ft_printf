...
void	basic_value(void)
{
	...
	two = 0;
	printf("---------12---------\n");
	one = printf("%020pa", "abcd");
	printf("\n");
	two = ft_printf("%020pa", "abcd");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
		printf("---------12---------\n");
	one = printf("%0-20pa", "abcd");
	printf("\n");
	two = ft_printf("%0-20pa", "abcd");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
		printf("---------12---------\n");
	one = printf("%0*pa", 20, "abcd");
	printf("\n");
	two = ft_printf("%0*pa", 20, "abcd");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("---------12---------\n");
	one = printf("%0*.*pa", 20, 0, "abcd");
	printf("\n");
	two = ft_printf("%0*.*pa", 20, 0, "abcd");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
		printf("---------12---------\n");
	one = printf("%0*.*pa", 20, 30, "abcd");
	printf("\n");
	two = ft_printf("%0*.*pa", 20, 30, "abcd");
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");
	printf("---------13---------\n");
	   one = printf("%-*.*pa", 5, 0, 12);
	printf("\n");
	two = ft_printf("%-*.*pa", 5, 0, 12);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------1---------\n");
	...
	printf("\n");	
	printf("---------1---------\n");
	one = printf("%0*pa", -1, INT_MIN);
	printf("\n");
	two = ft_printf("%0*pa", -1, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
	...
	printf("\n");		
printf("---------1---------\n");
	one = printf("%*pa", -1, INT_MIN);
	printf("\n");
	two = ft_printf("%*pa", -1, INT_MIN);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
...
printf("---------2---------\n");
	...
	printf("---------3---------\n");
	one = printf("%*.*p", 8, NULL, NULL);
	printf("\n");
	printf("one=%d\n", one);
	two = ft_printf("%*.*p", 8, NULL, NULL);
	printf("\n");
	printf("two=%d\n", two);
	if (one == two)
		ft_putstr_fd("OK", 1);
	...
	printf("\n");
	printf("---------3---------\n");
	one = printf("%*.*p", 0, NULL, NULL);
	printf("\n");
	printf("one=%d\n", one);
	two = ft_printf("%*.*p", 0, NULL, NULL);
	printf("\n");
	printf("two=%d\n", two);
	if (one == two)
		ft_putstr_fd("OK", 1);
	...
	printf("\n");
	printf("---------3---------\n");
	one = printf("%*.*p", 1, NULL, NULL);
	printf("\n");
	printf("one=%d\n", one);
	two = ft_printf("%*.*p", 1, NULL, NULL);
	printf("\n");
	printf("two=%d\n", two);
	if (one == two)
		ft_putstr_fd("OK", 1);
	...
	printf("\n");
	printf("---------3---------\n");
	one = printf("%*.*p", 2, NULL, NULL);
	printf("\n");
	printf("one=%d\n", one);
	two = ft_printf("%*.*p", 2, NULL, NULL);
	printf("\n");
	printf("two=%d\n", two);
	if (one == two)
		ft_putstr_fd("OK", 1);
	...
	printf("\n");
	printf("---------3---------\n");
	one = printf("%*.*p", 3, NULL, NULL);
	printf("\n");
	printf("one=%d\n", one);
	two = ft_printf("%*.*p", 3, NULL, NULL);
	printf("\n");
	printf("two=%d\n", two);
	if (one == two)
		ft_putstr_fd("OK", 1);
...
void	wisth_min_max(void)
{
	...
	printf("---------WIsTH_MAX0s ---------\n");
	  one = printf("%02147483647p", "2147483647");
	printf("\n");
	two = ft_printf("%02147483647p", 2147483647);
	printf("\n");
	if (one == two)
		ft_putstr_fd("OK", 1);
	else
